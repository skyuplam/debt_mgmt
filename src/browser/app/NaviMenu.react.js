        ...
        <LeftNav open={open}>
          ...
          </MenuItem>
          {
            ...
            <div>
              ...
              <MenuItem onTouchTap={() => this.redirectTo(LINKS.portfolios)}>
                <FormattedMessage
                  {...linksMessages.portfolios}
                />
              </MenuItem>
              ...
              <MenuItem onTouchTap={() => this.redirectTo(LINKS.placement)}>
                <FormattedMessage
                  {...linksMessages.placement}
                />
              </MenuItem>
            </div>
            : null
