...
import { uploadPlacement } from '../../common/upload/actions';

class Boarding extends Component {
  static propTypes = {
    intl: intlShape.isRequired,
    uploadPlacement: PropTypes.func.isRequired,
  ...
  handleDrop(files) {
    const { uploadPlacement, viewer } = this.props;
    uploadPlacement(files, viewer);
  }


  render() {
    const { intl } = this.props;
    const title = intl.formatMessage(uploadMessages.placementTitle);
